...
|---|---|---|
| Windows | MSVC 19.4x (x64) | full `ctest` green (192/192), pure-core digests pinned |
| macOS | Apple clang (arm64) | 344 Metal render goldens `DIFF 0.0000` + pure-core digests match |
